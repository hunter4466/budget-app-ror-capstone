...
RSpec.describe 'in user food index page', js: true, type: :system do
  ...
  describe 'I can see' do
    ...
    it 'the add new category screen' do
      visit splash_show_path
      click_link 'Log in'
      fill_in 'E-mail', with: 'user1@mail.com'
      fill_in 'Password', with: '111111'
    ...
    it 'that it creates a category succesfully' do
      visit splash_show_path
      click_link 'Log in'
      fill_in 'E-mail', with: 'user1@mail.com'
      fill_in 'Password', with: '111111'
      ...
      fill_in 'Place your icon url here', with: 'https://lorempixel.com/200/200/food/'
      click_button 'CREATE'
